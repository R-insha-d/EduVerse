...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  canvas#pc { position: absolute; top: 0; left: 0; pointer-events: none; width: 100%; height: 100%; }
  svg#sv { position: relative; z-index: 10; overflow: visible; width: 300px; height: 480px; }
...
function Auth() {
    ...
    useEffect(() => {
        ...
        const shd = document.getElementById('shadow');

        const g = {
            root: document.getElementById('gRoot'),
            back: document.getElementById('gBack'),
            torso: document.getElementById('gTorso'),
            head: document.getElementById('gHead'),
            lShoulder: document.getElementById('gLShoulder'),
            rShoulder: document.getElementById('gRShoulder'),
            lElbow: document.getElementById('gLElbow'),
            rElbow: document.getElementById('gRElbow'),
            lHip: document.getElementById('gLHip'),
            rHip: document.getElementById('gRHip'),
            lKnee: document.getElementById('gLKnee'),
            rKnee: document.getElementById('gRKnee'),
        ...
        function animate() {
            ...
            for (const k in t) s[k] = lerp(s[k] || 0, t[k], sp[k] || .09);
        ...
        <><style>{styles}</style><div className="auth-container">
            <div className="auth-left">
                ...
                <div className="auth-left-content">
                    ...
                    <p>Elevate your creative workflow with our next-generation platform tools.</p>
                    <div className="stage" id="stage">
                        <canvas id="pc"></canvas>
                        <svg id="sv" width="320" height="520" viewBox="0 0 320 520">
                            <defs>
                                <radialGradient id="skinG" cx="45%" cy="35%" r="65%">
                                    <stop offset="0%" stopColor="#5a3018" />
                                    <stop offset="100%" stopColor="#2a1508" />
                                </radialGradient>
                            </defs>
                            <ellipse id="shadow" cx="155" cy="498" rx="65" ry="11" fill="rgba(0,0,0,0.5)" />
                            <g id="gRoot">
                                <g id="gBack">
                                ...
                                <g id="gLShoulder">
                                    ...
                                    <g id="gLElbow">
                                        ...
                                        <ellipse cx="72" cy="303" rx="13" ry="11" fill="url(#skinG)" />
                                ...
                                <g id="gTorso">
                                    ...
                                    <g id="gRShoulder">
                                        ...
                                        <g id="gRElbow">
                                            ...
                                            <ellipse cx="206" cy="303" rx="13" ry="11" fill="url(#skinG)" />
                                    ...
                                    <g id="gHead">
                                        <ellipse cx="140" cy="152" rx="52" ry="54" fill="url(#skinG)" />
                                        ...
                                        <circle id="el" cx="117" cy="160" r="4" fill="#fff" />
                                        <circle id="er" cx="165" cy="160" r="4" fill="#fff" />
                                        ...
                                        <path id="smile" d="M125 184 Q140 198 155 184" stroke="#f5c400" strokeWidth="3" fill="none" strokeLinecap="round" />
            ...
            <div className="auth-right">
                <div className="auth-right-header">
                    ...
                    <p>Fill in your details to get started with EduVerse.</p>
                </div>
                ...
                <form className="auth-form" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button type="submit" className="submit-btn" onClick={() => (window.location.href = '/admin')}>Create Account</button>
                </form>
            ...
            <div className="cursor-char" id="cur"></div>
        </div></>
    );
}
